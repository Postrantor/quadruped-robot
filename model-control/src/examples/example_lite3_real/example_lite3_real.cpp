...
int main(int argc, char** argv) {
  ...
  // Controller2GazeboMsg *controller2gazeboMsg = new Controller2GazeboMsg(quadruped,
  // locomotionController, nh);
  ...
  while (ros::ok() && currentTime - startTime < MAX_TIME_SECONDS) {
    ...
    //     SwitchMode(quadruped, locomotionController, desiredSpeed, desiredTwistingSpeed,
    //     switchMode, startTimeWall);
    // }
    ...
    // if (count % 1 ==0) {
    //     // cout << "count = " << count << ", H in Control Frame = " <<
    //     quadruped->stateDataFlow.heightInControlFrame << endl; cout << "base pos:" <<
    //     quadruped->basePosition<<endl; cout << "base rpy:" <<
    //     quadruped->baseRollPitchYaw.transpose() <<endl; cout << "base w:" <<
    //     quadruped->baseRollPitchYawRate.transpose() <<endl;
