...
Mat6<typename T::Scalar> motionCrossMatrix(const Eigen::MatrixBase<T> &v) {
  ...
  m << 0, -v(2), v(1), 0, 0, 0, v(2), 0, -v(0), 0, 0, 0, -v(1), v(0), 0, 0, 0, 0,
      ...
      0, -v(5), v(4), 0, -v(2), v(1), v(5), 0, -v(3), v(2), 0, -v(0), -v(4), v(3), 0, -v(1), v(0),
      0;
  return m;
}
...
Mat6<typename T::Scalar> forceCrossMatrix(const Eigen::MatrixBase<T> &v) {
  ...
  f << 0, -v(2), v(1), 0, -v(5), v(4), v(2), 0, -v(0), v(5), 0, -v(3), -v(1), v(0), 0, -v(4), v(3),
      0, 0, 0, 0, 0, -v(2), v(1), 0, 0, 0, v(2), 0, -v(0), 0, 0, 0, -v(1), v(0), 0;
  return f;
}
 ...
 */
template <typename T>
SVec<typename T::Scalar> motionCrossProduct(
 ...
 */
template <typename T>
SVec<typename T::Scalar> forceCrossProduct(
    const Eigen::MatrixBase<T> &a, const Eigen::MatrixBase<T> &b) {
  static_assert(T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 6, "Must have 6x1 vector");
  SVec<typename T::Scalar> mv;
  mv << b(2) * a(1) - b(1) * a(2) - b(4) * a(5) + b(5) * a(4),
      b(0) * a(2) - b(2) * a(0) + b(3) * a(5) - b(5) * a(3),
      b(1) * a(0) - b(0) * a(1) - b(3) * a(4) + b(4) * a(3), b(5) * a(1) - b(4) * a(2),
      b(3) * a(2) - b(5) * a(0), b(4) * a(0) - b(3) * a(1);
  return mv;
}
...
Mat6<typename T::Scalar> createSXform(
    const Eigen::MatrixBase<T> &R, const Eigen::MatrixBase<T2> &r) {
...
Mat3<typename T::Scalar> rotInertiaOfBox(
    typename T::Scalar mass, const Eigen::MatrixBase<T> &dims) {
 ...
 */
template <typename T, typename T2>
Vec3<typename T::Scalar> spatialToLinearVelocity(
    const Eigen::MatrixBase<T> &v, const Eigen::MatrixBase<T2> &x) {
  static_assert(T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 6, "Must have 6x1 vector");
...
Vec3<typename T::Scalar> spatialToLinearAcceleration(
    const Eigen::MatrixBase<T> &a, const Eigen::MatrixBase<T2> &v) {
  static_assert(T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 6, "Must have 6x1 vector");
 ...
 */
template <typename T, typename T2>
Vec3<typename T::Scalar> sXFormPoint(
    const Eigen::MatrixBase<T> &X, const Eigen::MatrixBase<T2> &p) {
 ...
 */
template <typename T, typename T2>
SVec<typename T::Scalar> forceToSpatialForce(
    const Eigen::MatrixBase<T> &f, const Eigen::MatrixBase<T2> &p) {
  static_assert(T::ColsAtCompileTime == 1 && T::RowsAtCompileTime == 3, "Must have 3x1 vector");
  static_assert(T2::ColsAtCompileTime == 1 && T2::RowsAtCompileTime == 3, "Must have 3x1 vector");
