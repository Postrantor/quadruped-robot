 ...
 *	\author Andreas Waechter and Dennis Janka, based on QProblem.hpp by Hans Joachim Ferreau, Andreas Potschka,
...
private:
  ...
  returnValue stepCalcBacksolveSchur(
      int_t nFR,
      int_t nFX,
      int_t nAC,
      int_t* FR_idx,
...
protected:
  ...
  int_t nS;    /**< Current size of Schur complement matrix. -1 means that the Schur complement has not yet been
                  initialized. */
  ...
  real_t* M_vals; /**< Values of the sparse M matrix containing the vectors with the additional rows defining the Schur
                     complement (length). */
