...
enum returnValue {
  ...
  RET_CONSTRAINTS_NOT_SPECIFIED,     /**< Problem does comprise constraints! You also have to specify new constraints'
                                        bounds. */
...
public:
   ...
   *  Warnings are definied as abnormal events which does NOT cause an immediate termination of the current (sub)
   * function. \return Warning number returned by sub function call
   */
