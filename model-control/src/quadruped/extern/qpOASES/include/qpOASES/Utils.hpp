 ...
 * \return SUCCESSFUL_RETURN */
returnValue print(
    const int_t* const index, /**< Index array to be printed. */
 ...
 * \return SUCCESSFUL_RETURN \n
                   ...
                   RET_UNABLE_TO_READ_FILE */
returnValue readFromFile(
    int_t* data,             /**< Vector to be read from file. */
    int_t n,                 /**< Length of vector. */
    const char* datafilename /**< Data file name. */
);
...
returnValue writeIntoFile(
    ...
    const char* datafilename, /**< Data file name. */
    BooleanType append =
        BT_FALSE /**< Indicates if data shall be appended if the file already exists (otherwise it is overwritten). */
);
...
returnValue writeIntoFile(
    ...
    int_t n,                      /**< Length of vector. */
    const char* datafilename,     /**< Data file name. */
    BooleanType append = BT_FALSE /**< Indicates if integer shall be appended if the file already exists (otherwise it
                                     is overwritten). */
);
...
inline BooleanType isEqual(
    real_t x,         /**< First real number. */
...
inline BooleanType isZero(
    real_t x,         /**< Real number. */
    real_t TOL = ZERO /**< Tolerance for comparison. */
);
...
returnValue getKktViolation(
    ...
    BooleanType hasIdentityHessian =
        BT_FALSE /**< Indicating whether Hessian matrix is identity matrix or not if NULL pointer is passed. */
);
