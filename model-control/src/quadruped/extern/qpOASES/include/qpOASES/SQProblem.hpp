...
public:
  ...
  returnValue hotstart(
      SymmetricMatrix* H_new,    /**< Hessian matrix of neighbouring QP to be solved (a shallow copy is made). \n
   ...
   *	\return SUCCESSFUL_RETURN \n
                          ...
                          RET_SETUP_AUXILIARYQP_FAILED */
  returnValue hotstart(
      const real_t* const H_new, /**< Hessian matrix of neighbouring QP to be solved (a shallow copy is made). \n
                                                                                          If Hessian matrix is trivial,
...
protected:
  ...
  virtual returnValue setupNewAuxiliaryQP(
      SymmetricMatrix* H_new, /**< New Hessian matrix. \n
                                                                                                       If Hessian matrix
