...
void sci_QProblem_hotstart(
    ...
    int_t* nWSRout,
    real_t* y);
void sci_QProblemB_hotstart(
    real_t* g, real_t* lb, real_t* ub, int_t* nWSR, real_t* x, real_t* obj, int_t* status, int_t* nWSRout, real_t* y);
void sci_SQProblem_hotstart(
    real_t* H,
    real_t* g,
    real_t* A,
    real_t* lb,
...
int interface_qpOASES(char* fname) {
  ...
  sci_qpOASES(
      stk(H), stk(g), stk(A), (lb_rows != 0) ? stk(lb) : 0, (ub_rows != 0) ? stk(ub) : 0,
      (lbA_rows != 0) ? stk(lbA) : 0, (ubA_rows != 0) ? stk(ubA) : 0, &H_rows, &A_rows, istk(nWSR), stk(x), stk(obj),
      istk(status), istk(nWSRout), stk(y));
...
int interface_QProblemB_init(char* fname) {
  ...
  /* call interfaced qpOASES routines with appropriate arguments */
  sci_QProblemB_init(
      stk(H), stk(g), (lb_rows != 0) ? stk(lb) : 0, (ub_rows != 0) ? stk(ub) : 0, &H_rows, istk(nWSR), stk(x), stk(obj),
      istk(status), istk(nWSRout), stk(y));
...
int interface_QProblem_hotstart(char* fname) {
  ...
  /* call interfaced qpOASES routines with appropriate arguments */
  sci_QProblem_hotstart(
      stk(g), (lb_rows != 0) ? stk(lb) : 0, (ub_rows != 0) ? stk(ub) : 0, (lbA_rows != 0) ? stk(lbA) : 0,
      (ubA_rows != 0) ? stk(ubA) : 0, istk(nWSR), stk(x), stk(obj), istk(status), istk(nWSRout), stk(y));
...
int interface_QProblemB_hotstart(char* fname) {
  ...
  /* call interfaced qpOASES routines with appropriate arguments */
  sci_QProblemB_hotstart(
      stk(g), (lb_rows != 0) ? stk(lb) : 0, (ub_rows != 0) ? stk(ub) : 0, istk(nWSR), stk(x), stk(obj), istk(status),
      istk(nWSRout), stk(y));
...
int interface_SQProblem_hotstart(char* fname) {
  ...
  /* call interfaced qpOASES routines with appropriate arguments */
  sci_SQProblem_hotstart(
      stk(H), stk(g), stk(A), (lb_rows != 0) ? stk(lb) : 0, (ub_rows != 0) ? stk(ub) : 0,
      (lbA_rows != 0) ? stk(lbA) : 0, (ubA_rows != 0) ? stk(ubA) : 0, istk(nWSR), stk(x), stk(obj), istk(status),
      istk(nWSRout), stk(y));
...
int C2F(qpOASESgateway)() {
  gate_function function[] = {interface_qpOASES,
                              interface_QProblem_init,
                              interface_QProblemB_init,
                              interface_SQProblem_init,
                              interface_QProblem_hotstart,
                              interface_QProblemB_hotstart,
                              interface_SQProblem_hotstart,
                              interface_QProblem_cleanup,
                              interface_QProblemB_cleanup,
                              interface_SQProblem_cleanup};
  char* name[] = {"qpOASES",           "qpOASES_init",       "qpOASES_initSB",     "qpOASES_initVM",
                  "qpOASES_hotstart",  "qpOASES_hotstartSB", "qpOASES_hotstartVM", "qpOASES_cleanup",
                  "qpOASES_cleanupSB", "qpOASES_cleanupVM"};
