...
//     LoopFunc loop_control("control_loop", robotInterface.dt, boost::bind(&RobotInterface::ReceiveObservation,
//     &robotInterface)); LoopFunc loop_udpSend("udp_send",     robotInterface.dt, 2,
//     boost::bind(&RobotInterface::UDPSend, &robotInterface)); LoopFunc loop_udpRecv("udp_recv",     robotInterface.dt,
//     2, boost::bind(&RobotInterface::UDPRecv, &robotInterface));
