...
TEST_SUBMODULE(methods_and_attributes, m) {
      ...
      .def_static(
          ...
          []() {
            auto emna = py::reinterpret_borrow<py::class_<ExampleMandA>>(
                py::module_::import("pybind11_tests.methods_and_attributes").attr("ExampleMandA"));
  ...
  py::class_<TestProperties>(m, "TestProperties")
      ...
      .def_property_readonly_static(
          "def_property_readonly_static", [](py::object) { return TestProperties::static_get(); })
      .def_property_static(
  ...
  // UnregisteredBase; before this tests/fix they would be registered via lambda with a first
