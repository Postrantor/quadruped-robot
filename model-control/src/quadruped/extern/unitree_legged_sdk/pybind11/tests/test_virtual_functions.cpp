...
class NCVirtTrampoline : public NCVirt {
  ...
  NonCopyable get_noncopyable(int a, int b) override { PYBIND11_OVERRIDE(NonCopyable, NCVirt, get_noncopyable, a, b); }
#endif
...
struct DispatchIssue : Base {
  std::string dispatch() const override { PYBIND11_OVERRIDE_PURE(std::string, Base, dispatch, /* no arguments */); }
};
...
public:                                                                                                          \
  ...
  std::string say_something(unsigned times) override { return "B says hi " + std::to_string(times) + " times"; } \
