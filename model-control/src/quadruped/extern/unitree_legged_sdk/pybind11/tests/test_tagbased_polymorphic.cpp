/*
    tests/test_tagbased_polymorphic.cpp -- tests of polymorphic_type_hook
...
struct Animal {
  ...
  enum class Kind { Unknown = 0, Dog = 100, Labrador, Chihuahua, LastDog = 199, Cat = 200, Panther, LastCat = 299 };
...
struct Labrador : Dog {
  Labrador(const std::string& _name, int _excitement = 9001) : Dog(_name, Kind::Labrador), excitement(_excitement) {}
  int excitement;
};
