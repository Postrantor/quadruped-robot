...
TEST_SUBMODULE(builtin_casters, m) {
  ...
  // Some tests characters in utf16 and utf32 encodings.  The last one (the 𝐀) contains a null byte
  ...
  m.def(
      "good_utf8_u8string", []() { return std::u8string(u8"Say utf8\u203d \U0001f382 \U0001d400"); });  // Say utf8‽ 🎂 𝐀
  ...
  // test_tuple
  m.def(
      "pair_passthrough", [](std::pair<bool, std::string> input) { return std::make_pair(input.second, input.first); },
  ...
  m.def("rvalue_nested", []() {
    return std::make_pair(
        RValueCaster{}, std::make_tuple(RValueCaster{}, std::make_pair(RValueCaster{}, RValueCaster{})));
  });
  ...
  // tests int vs. long (Python 2)
  m.def("int_cast", []() { return (int)42; });
  m.def("long_cast", []() { return (long)42; });
  m.def("longlong_cast", []() { return ULLONG_MAX; });

  /// tests void* cast operator
