...
PYBIND11_MODULE(pybind11_cross_module_tests, m) {
  m.doc() = "pybind11 cross-module tests module";
  ...
  // globally in the main tests module):
  ...
  // test_vector_bool
  // We can't tests both stl.h and stl_bind.h conversions of `std::vector<bool>` within
  ...
  // The main module already includes stl.h, but we need to tests the error message
