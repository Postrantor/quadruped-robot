...
TEST_SUBMODULE(local_bindings, m) {
  ...
  // The main pybind11 tests module is loaded first, so this registration will succeed (the second
  ...
  m.def(
      "register_mixed_local", [m]() { bind_local<MixedLocalGlobal, 1000>(m, "MixedLocalGlobal", py::module_local()); });
