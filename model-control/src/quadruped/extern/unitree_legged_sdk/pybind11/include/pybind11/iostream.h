...
private:
  ...
  // rare MSVC tests failure shows up with this version, then this should be
...
public:
  OstreamRedirect(bool do_stdout = true, bool do_stderr = true) : do_stdout_(do_stdout), do_stderr_(do_stderr) {}
