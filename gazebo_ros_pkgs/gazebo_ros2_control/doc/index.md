---
github_url: |
  <https://github.com/ros-controls/gazebo_ros2_control/blob/%7BREPOS_FILE_BRANCH%7D/doc/index.rst>
---
...
> 除了 _ros2_control_ 标签之外，还需要在 URDF 中添加一个 Gazebo 插件，以实际解析 _ros2_control_ 标签并**加载相应的硬件接口和控制器管理器**。默认情况下，_gazebo_ros2_control_ 插件非常简单，但它也可通过附加插件架构进行扩展，允许高级用户在 _ros2_control_ 和 Gazebo Classic 之间创建自己的自定义机器人硬件接口。
