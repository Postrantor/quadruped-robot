...
MPCStanceLegController::MPCStanceLegController(
   ...
   * Interval of two MPC updates is dtMPC. If MPC length is horizonLength，then this MPC considers dtMPC*horizonLength
   * time. Generally, the gait period T = dtMPC * HorizonLength * numHorizonL.
   */
