...
void qrFootholdPlanner::Reset(float t) {
  ...
  firstSwingBaseState << robot->basePosition, robot->stateDataFlow.baseVInWorldFrame, robot->baseRollPitchYaw,
...
void qrFootholdPlanner::ComputeMITFootHold(int legId) {
  ...
  Vec3<float> pYawCorrected =
      robotics::math::coordinateRotation(CoordinateAxis::Z, -desiredTwistingSpeed * stance_time / 2) *
