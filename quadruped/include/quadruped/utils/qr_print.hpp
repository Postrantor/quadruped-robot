...
template <typename T>
void pretty_print(
    Quat<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}

template <typename T>
void pretty_print(
    DVec<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}

template <typename T>
void pretty_print(
    D3Mat<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, false, nonl);
}

template <typename T>
void pretty_print(
    Mat3<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, false, nonl);
}

template <typename T>
void pretty_print(
    Mat6<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, false, nonl);
}

template <typename T>
void pretty_print(
    SVec<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}

template <typename T>
void pretty_print(
    Vec3<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}

template <typename T>
void pretty_print(
    Vec2<T> const &vv, std::ostream &os, std::string const &title, std::string const &prefix = "", bool nonl = false) {
  pretty_print((DMat<T> const &)vv, os, title, prefix, true, nonl);
}
