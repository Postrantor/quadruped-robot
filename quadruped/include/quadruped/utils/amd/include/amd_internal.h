...
GLOBAL size_t AMD_aat(Int n, const Int Ap[], const Int Ai[], Int Len[], Int Tp[], c_float Info[]);
...
GLOBAL void AMD_postorder(
    Int nn, Int Parent[], Int Npiv[], Int Fsize[], Int Order[], Int Child[], Int Sibling[], Int Stack[]);
...
#define AMD_DEBUG1(params)                          \
  {                                                 \
    if (AMD_debug >= 1) SUITESPARSE_PRINTF(params); \
  }
#define AMD_DEBUG2(params)                          \
  {                                                 \
    if (AMD_debug >= 2) SUITESPARSE_PRINTF(params); \
  }
#define AMD_DEBUG3(params)                          \
  {                                                 \
    if (AMD_debug >= 3) SUITESPARSE_PRINTF(params); \
  }
#define AMD_DEBUG4(params)                          \
  {                                                 \
    if (AMD_debug >= 4) SUITESPARSE_PRINTF(params); \
  }
