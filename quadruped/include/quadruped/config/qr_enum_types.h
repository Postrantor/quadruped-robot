...
enum MotorMode { POSITION_MODE, TORQUE_MODE, HYBRID_MODE };

/** @brief motor command composite*/
enum HybridCmd { POSITION, KP, VELOCITY, KD, TORQUE };
...
enum LocomotionMode { VELOCITY_LOCOMOTION, POSITION_LOCOMOTION, WALK_LOCOMOTION, ADVANCED_TROT };

enum TerrainType { PLANE = 0, PLUM_PILES, STAIRS, SLOPE, ROUGH };
