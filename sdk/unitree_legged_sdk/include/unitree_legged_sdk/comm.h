...
/**
 * @brief when under accelerated motion, the attitude of the robot calculated by IMU will drift.
 */
typedef struct {
...
typedef struct {
  ...
  float bodyHeight;
  // (unit: m), desired position in inertial frame, reserve
