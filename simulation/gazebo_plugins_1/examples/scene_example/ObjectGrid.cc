...
//////////////////////////////////////////////////
ObjectGrid::ObjectGrid(int num_x, int num_y, float size_x, float size_y, float size_z)
    : num_cells_x(num_x), num_cells_y(num_y), grid_x(size_x), grid_y(size_y), cell_z(size_z) {
  // Create cell array
