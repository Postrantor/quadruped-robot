...
int main(int _argc, char **_argv) {
  ...
  std::vector<std::string> visuals{"rh_forearm",    "rh_wrist",      "rh_palm",     "rh_imu",      "rh_ffknuckle",
                                   "rh_ffproximal", "rh_ffmiddle",   "rh_ffdistal", "rh_fftip",    "rh_mfknuckle",
                                   "rh_mfproximal", "rh_mfmiddle",   "rh_mfdistal", "rh_mftip",    "rh_rfknuckle",
                                   "rh_rfproximal", "rh_rfmiddle",   "rh_rfdistal", "rh_rftip",    "rh_lfmetacarpal",
  ...
  for (int i = 0; i < 20; i++) {
    for (auto const visual : visuals) {
      ...
      interface.addColors(
          color_msg, visual, parent, Color(r, g, b), Color(r, g, b), Color(0.1, 0, 0.1), Color(0.2, 0.2, 0.2, 64));
...
/////////////////////////////////////////////////
void inline waitMs(int delay) { std::this_thread::sleep_for(std::chrono::milliseconds(delay)); }
