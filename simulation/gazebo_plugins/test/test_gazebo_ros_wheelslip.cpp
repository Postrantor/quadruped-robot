...
public:
  void test_parameters(std::string world_file, std::string node_name, std::map<std::string, double> parameter_pairs) {
    // Load the world
...
TEST_F(GazeboRosWheelSlipTest, TestRosGlobalParamsOverrideSdf) {
  ...
  this->test_parameters(
      "worlds/wheelslip_worlds/gazebo_ros_wheelslip_2.world", "trisphere_cycle_slip0/wheel_slip_front",
      parameter_pairs);
}
...
TEST_F(GazeboRosWheelSlipTest, TestRosGlobalParamsApply) {
  ...
  this->test_parameters(
      "worlds/wheelslip_worlds/gazebo_ros_wheelslip_3.world", "trisphere_cycle_slip0/wheel_slip_front",
      parameter_pairs);
}
...
TEST_F(GazeboRosWheelSlipTest, RosLocalParamsOverrideSdf) {
  ...
  this->test_parameters(
      "worlds/wheelslip_worlds/gazebo_ros_wheelslip_4.world", "trisphere_cycle_slip0/wheel_slip_front",
      parameter_pairs);
}
...
TEST_F(GazeboRosWheelSlipTest, TestRosGlobalParamsOverrideAll) {
  ...
  this->test_parameters(
      "worlds/wheelslip_worlds/gazebo_ros_wheelslip_5.world", "trisphere_cycle_slip0/wheel_slip_rear", parameter_pairs);
}
...
TEST_F(GazeboRosWheelSlipTest, TestSetParameters) {
  ...
  auto parameters_client =
      std::make_shared<rclcpp::SyncParametersClient>(node, "trisphere_cycle_slip0/wheel_slip_rear");
...
public:
  void test_publishing(std::string world_file, bool at_rest) {
    ...
    auto sub = node->create_subscription<gazebo_msgs::msg::WheelSlip>(
        ...
        [&latestMsg](const gazebo_msgs::msg::WheelSlip::SharedPtr msg) { latestMsg = msg; });
...
TEST_F(GazeboRosWheelSlipPublisherTest, Publishing) {
  this->test_publishing("worlds/gazebo_ros_wheel_slip.world", false);
}

TEST_F(GazeboRosWheelSlipPublisherTest, PublishingAtRest) {
  this->test_publishing("worlds/gazebo_ros_wheel_slip_at_rest.world", true);
}
