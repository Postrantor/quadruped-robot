...
//////////////////////////////////////////////////
DRInterface::DRInterface(const std::string &req_topic_, const std::string &res_topic_)
  ...
  debugPrintTrace(
      "DRInterface initialized." << std::endl
...
//////////////////////////////////////////////////
DRInterface::~DRInterface() { this->sub->Unsubscribe(); }
...
//////////////////////////////////////////////////
void DRInterface::addGravity(DRRequest &msg, const ignition::math::Vector3d &gravity) {
...
//////////////////////////////////////////////////
void DRInterface::addModelScale(DRRequest &msg, const std::string &model, const ignition::math::Vector3d &scale) {
...
//////////////////////////////////////////////////
void DRInterface::addLinkMass(DRRequest &msg, const std::string &model, const std::string &link, double mass) {
  gazebo::msgs::Model *model_msg;
...
//////////////////////////////////////////////////
void DRInterface::addInertiaMatrix(
    DRRequest &msg,
...
void DRInterface::addModelCmd(
  ...
  if (type != POSITION && type != VELOCITY) {
    return;
  }
  ...
  if (type == POSITION) {
    pid = joint_cmd->mutable_position();
  } else {
    pid = joint_cmd->mutable_velocity();
  }
...
void DRInterface::addColors(
  ...
  gazebo::msgs::Color *ambient_msg, *diffuse_msg, *emissive_msg, *specular_msg;
