...
typedef const boost::shared_ptr<const gap::msgs::DRResponse> DRResponsePtr;
...
public:
  DRInterface(const std::string &req_topic_, const std::string &res_topic_);
...
public:
  void publish(DRRequest &msg, bool blocking = false);
...
public:
  void publish(gazebo::msgs::Visual &msg, bool blocking = false);
...
public:
  void onResponse(DRResponsePtr &_msg);
};
