/**
 * This example demonstrates how to use ROS2 to receive wireless controller states of unitree go2
 * robot
 */
...
private:
  void topic_callback(unitree_go::msg::WirelessController::SharedPtr data) {
    ...
    RCLCPP_INFO(
        this->get_logger(), "Wireless controller -- lx: %f; ly: %f; rx: %f; ry: %f; key value: %d",
