...
typedef struct {
  ...
  float forwardPosition;  // front or rear displacement, an integrated number form kinematics
                          // function, usually drift
  float sidePosition;  // left or right displacement, an integrated number form kinematics function,
                       // usually drift
