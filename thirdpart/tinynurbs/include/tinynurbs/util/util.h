 ...
 */
template <int nd, typename T>
inline void homogenousToCartesian(
    const std::vector<glm::vec<nd, T>> &ptsws, std::vector<glm::vec<nd - 1, T>> &pts, std::vector<T> &ws) {
  pts.clear();
  ws.clear();
...
template <int nd, typename T>
inline void homogenousToCartesian(
    const array2<glm::vec<nd, T>> &ptsws, array2<glm::vec<nd - 1, T>> &pts, array2<T> &ws) {
 ...
 */
template <int nd, typename T>
inline std::vector<glm::vec<nd + 1, T>> cartesianToHomogenous(
    const std::vector<glm::vec<nd, T>> &pts, const std::vector<T> &ws) {
 ...
 */
template <int nd, typename T>
inline array2<glm::vec<nd + 1, T>> cartesianToHomogenous(const array2<glm::vec<nd, T>> &pts, const array2<T> &ws) {
