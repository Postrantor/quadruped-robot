...
void TagAliasRegistry::add(std::string const &alias, std::string const &tag, SourceLineInfo const &lineInfo) {
  CATCH_ENFORCE(
      startsWith(alias, "[@") && endsWith(alias, ']'), "error: tag alias, '" << alias
...
void enforceNoDuplicateTestCases(std::vector<TestCase> const &functions) {
  ...
  for (auto const &function : functions) {
    ...
    CATCH_ENFORCE(
        prev.second, "error: TEST_CASE( \"" << function.name << "\" ) already defined.\n"
...
#define CATCH_CHECK_FALSE(...)                                                                                \
  INTERNAL_CATCH_TEST(                                                                                        \
      "CATCH_CHECK_FALSE", Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::FalseTest, \
      __VA_ARGS__)
...
#define CATCH_CHECK_NOFAIL(...)                                                                                   \
  INTERNAL_CATCH_TEST(                                                                                            \
      "CATCH_CHECK_NOFAIL", Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::SuppressFail, \
      __VA_ARGS__)
...
#define CHECK_NOFAIL(...)                                                                                   \
  INTERNAL_CATCH_TEST(                                                                                      \
      "CHECK_NOFAIL", Catch::ResultDisposition::ContinueOnFailure | Catch::ResultDisposition::SuppressFail, \
      __VA_ARGS__)
