...
unsigned int lcm_ringbuf_capacity(lcm_ringbuf_t *ring) { return ring->size; }

unsigned int lcm_ringbuf_used(lcm_ringbuf_t *ring) { return ring->used; }
