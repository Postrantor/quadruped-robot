...
static memq_msg_t *memq_msg_new(lcm_t *lcm, const char *channel, const void *data, int data_size, int64_t utime) {
...
static int lcm_memq_get_fileno(lcm_memq_t *self) { return self->notify_pipe[0]; }
...
static int lcm_memq_publish(lcm_memq_t *self, const char *channel, const void *data, unsigned int datalen) {
