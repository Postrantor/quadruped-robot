...
void MemqSimpleHandler(const lcm::ReceiveBuffer *rbuf, const std::string &channel, std::vector<uint8_t> *received_buf) {
...
void MemqBufferedHandler(
    const lcm::ReceiveBuffer *rbuf, const std::string &channel, std::vector<std::vector<uint8_t> > *received_buffers) {
...
void MemqTimeoutHandler(const lcm::ReceiveBuffer *rbuf, const std::string &channel, bool *msg_handled) {
  *msg_handled = true;
}
