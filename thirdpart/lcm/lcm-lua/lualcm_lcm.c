...
static int impl_lcm_tostring(lua_State *L) {
  ...
  /* make the string */
  lua_pushfstring(L, "lcm.lcm [v%d.%d.%d] (@ %p)", LCM_MAJOR_VERSION, LCM_MINOR_VERSION, LCM_MICRO_VERSION, lcmu);
...
static impl_lcm_userdata_t *impl_lcm_newuserdata(lua_State *L) {
  /* make new user data */
  impl_lcm_userdata_t *lcmu = (impl_lcm_userdata_t *)lua_newuserdata(L, sizeof(impl_lcm_userdata_t));
...
static void *impl_lcm_addtosubscriptiontable(
    lua_State *L, int index, int **ref_num_ptr, lcm_subscription_t ***subscription_double_ptr) {
  ...
  lua_pushstring(L, "userdata");
  impl_sub_userdata_t *subu = (impl_sub_userdata_t *)lua_newuserdata(L, sizeof(impl_sub_userdata_t));
  lua_rawset(L, -3);
 ...
 */
static int impl_lcm_getfromsubscriptiontable(lua_State *L, int index, int ref_num, lcm_subscription_t **subscription) {
  /* get lcm userdata */
  impl_lcm_getsubscriptiontable(L, index);
