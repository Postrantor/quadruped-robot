...
int signal_pipe_attach_glib(signal_pipe_glib_handler_t func, gpointer user_data) {
  ...
  g_io_channel_set_flags(g_sp.ioc, (GIOFlags)(g_io_channel_get_flags(g_sp.ioc) | G_IO_FLAG_NONBLOCK), NULL);
  g_sp.ios = g_io_add_watch(g_sp.ioc, (GIOCondition)(G_IO_IN | G_IO_PRI), (GIOFunc)signal_handler_glib, NULL);
