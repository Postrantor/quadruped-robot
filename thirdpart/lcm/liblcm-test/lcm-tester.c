...
static int64_t timestamp_seconds(int64_t v) { return v / 1000000; }

static int64_t timestamp_useconds(int64_t v) { return v % 1000000; }
...
static void test_handler(const lcm_recv_buf_t *rbuf, const char *channel, void *u) { test_count++; }

static void test_handler2(const lcm_recv_buf_t *rbuf, const char *channel, void *u) { test_count2++; }

static void catchall_handler(const lcm_recv_buf_t *rbuf, const char *channel, void *u) { catchall_count++; }

static void regex_handler(const lcm_recv_buf_t *rbuf, const char *channel, void *u) { printf("regex handler\n"); }
...
#undef FAIL_IFSNE
  ...
  int matched =
      (0 == test_count && ntotransmit == test_count2 &&
