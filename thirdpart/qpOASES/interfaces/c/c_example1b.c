...
int main() {
  ...
  /* Solve first QP. */
  nWSR = 10;
  QProblemB_init(H, g, lb, ub, (int_t* const)&nWSR, 0, &options, xOpt, yOpt, &obj, (int_t* const)&status);
  ...
  /* Solve second QP. */
  nWSR = 10;
  QProblemB_hotstart(g_new, lb_new, ub_new, (int_t* const)&nWSR, 0, xOpt, yOpt, &obj, (int_t* const)&status);
