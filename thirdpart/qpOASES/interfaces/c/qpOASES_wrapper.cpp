...
int_t qpOASES_obtainOutputs(
    const QProblemB* const globalQpObject,
    returnValue returnvalue,
    real_t* const x,
    real_t* const y,
    real_t* const obj,
    int_t* const status) {
  if (globalQpObject == 0) return -1;
...
int_t QProblem_setup(int_t nV, int_t nC, int_t hessianType) {
  if ((nV < 1) || (nC < 0)) return -1;

  if ((hessianType < 0) || (hessianType > 6)) return -1;

  if (QProblem_cleanup() != 0) return -1;
...
int_t QProblem_init(
  ...
  if (globalQProblemObject == 0) return -1;
...
int_t QProblemB_setup(int_t nV, int_t hessianType) {
  ...
  if (QProblemB_cleanup() != 0) return -1;
...
int_t QProblemB_init(
  ...
  if (globalQProblemBObject == 0) return -1;
...
int_t SQProblem_setup(int_t nV, int_t nC, int_t hessianType) {
  ...
  if (SQProblem_cleanup() != 0) return -1;
...
int_t SQProblem_init(
  ...
  if (globalSQProblemObject == 0) return -1;
